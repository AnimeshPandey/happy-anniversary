var SITE = {
  ...
  opening: {
    ...
    panels: [
      ...
      {
        id: 'panel-2',
        text: 'It didn\'t look like much from the outside. Just two people, one ordinary day, and an ordinary beginning to something extraordinary.',
        imageId: 'ceremony-bg'
      }
    ]
  },
  ...
  chapters: [
    {
      ...
      body: 'Every great love story has a beginning. Ours started quietly, unexpectedly — the kind of beginning you only recognise as a beginning once you\'re deep inside the middle of something wonderful. I remember noticing you and thinking: this is different. This one matters.',
      imageId: 'ch1-main',
      layout: 'left'
    },
    {
      number: '02',
      title: 'The first yes',
      body: 'You said yes. Three words that I have replayed more times than I can count. From that moment, the world arranged itself differently — everything that came before now part of the before, and everything after painted in a warmer light.',
      imageId: 'ch2-main',
      layout: 'right'
    },
    {
    ...
    },
    {
      ...
      body: 'The best adventures are the ones you almost don\'t take. We said yes with equal parts excitement and nerves, and what came back from it wasn\'t just photographs — it was a version of us that had learned how to be us together in new places. I want more of those.',
      imageId: 'ch4-main',
      layout: 'right'
    },
    {
      ...
      body: 'Love isn\'t the grand gestures — though those are wonderful. Love is the cup of tea before you asked for it. The way you remember what I mentioned once, weeks ago. The message that arrives exactly when I need it. The little things are, quietly, the whole thing.',
      imageId: 'ch5-main',
      layout: 'left'
    },
    {
    ...
    },
    {
      ...
      body: 'Not every memory is a highlight. Some of the best ones are Tuesday evenings, unhurried mornings, the easy silence of two people who don\'t need to fill every space with words. Those quiet moments are the architecture of something lasting, and I treasure every single one.',
      imageId: 'ch7-main',
      layout: 'left'
    },
    {
      ...
      body: 'I\'m different because of you. Better, I think — more patient, more open, more willing to feel things fully. You didn\'t try to change me; you just made space for me to grow into a version of myself I like more. That might be the most loving thing a person can do.',
      imageId: 'ch8-main',
      layout: 'right'
    },
    {
    ...
    },
    {
      ...
      body: 'I want to remember all of it. Not just the perfect days but the imperfect ones, the laughter that made no sense, the plans that changed, the moments we didn\'t know were becoming memories until they already were. I want to hold all of it. Every bit.',
      imageId: 'ch10-main',
      layout: 'right'
    },
    {
      ...
      body: 'A year in, and I find myself genuinely excited about everything still ahead. New places, new ordinary days, new versions of us. Whatever comes next, I know I want to face it with you beside me — and that certainty is its own kind of quiet, steady joy.',
      imageId: 'ch11-main',
      layout: 'left'
    },
    {
